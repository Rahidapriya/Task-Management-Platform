   ...
   const handleGoogle = () => {
    ...
    return (
        ...
        <div>
              ...
              <div className=" min-h-screen bg-base-200 relative h-screen" style={containerStyle}>
