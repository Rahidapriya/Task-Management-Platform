...
import registerhero from '../../assets/login.jpg'
...
// };
    return (
        <div className=" bg-base-200">
          <Navbar></Navbar>
          <div className="hero min-h-screen bg-base-200 relative h-screen" >
  ...
  <p className='md:w-96 text-sm text-center'>By continuing, you agree to Todoist's <span className='font-bold'>Terms of Service</span>; Opens a new tab and acknowledge you've read our Privacy Policy; Opens a new tab. </p>
  {/* {
