        ...
        <div>
            ...
            <div className='section h-screen mt-20 lg:mb-20 mb-96 ' id='contact'>
                <div className='bg-purple-500 flex justify-center items-center'>
                    <div>
<img src={contact} className='w-96 py-10' alt="" />
                    </div>
                    <div className='text-center'>
<h1 className='text-3xl'>Need Support?</h1>
...
{/* <img src={contact} className='w-96 header' alt="" data-aos="zoom-in-up" /> */}
  ...
  <div 
    className="relative grid mx-4 mb-4 -mt-6 overflow-hidden bg-purple-500 text-white shadow-lg h-28 place-items-center rounded-xl  btn-bgg bg-clip-border shadow-gray-900/20">
    <h3 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal  text-white ">
     Send Message
    </h3>
  </div>
  <form ref={form} onSubmit={sendEmail} className=' overflow-hidden'>
  ...
  <div className="p-6 ">
   <input type='submit' className='w-full bgg cursor-pointer text-white font-bold bg-purple-500  rounded-full py-3' value='Send'/>
    {/* <button
