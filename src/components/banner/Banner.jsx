    ...
    return (
        <div className="relative h-screen flex flex-col-reverse lg:flex-row   justify-center items-center px-10" style={containerStyle}>
            <div className=" lg:text-left text-center z-10 lg:w-5/12 mx-auto text-black ">
                ...
                <p className='text-sm mt-5 lg:text-xl md:w-10/12 lg:w-full md:mx-auto  text-gray-900'>Harness the power of efficiency with our user-friendly platform. Stay organized, focused, and in control of your tasks effortlessly. Elevate your productivity and manage your time like never before. Todoist, where organization meets simplicity for a more productive you!</p>
            </div>
